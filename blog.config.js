...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '278ad273b9f44c27b6ca0d583f6603cc,en:278ad273b9f44c27b6ca0d583f6603cc',
  ...
  SINCE: process.env.NEXT_PUBLIC_SINCE || 2003, // e.g if leave this empty, current year will be used.
  ...
  GREETING_WORDS:
    ...
    '就是这样的烂诗人, 泪眼之前的博客,Hi，我是一个幻想家,欢迎来到我的博客🎉',
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '幻想家', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://betears.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '泪眼之前的博客,就是这样的烂诗人,Notion, 博客', // 网站关键词 英文逗号隔开
