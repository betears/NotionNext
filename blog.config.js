...
const BLOG = {
  ...
  SINCE: process.env.NEXT_SINCE || 2003, // e.g if leave this empty, current year will be used.
  APPEARANCE: process.env.NEXT_PUBLIC_APPEARANCE || 'light', // ['light', 'dark', 'auto'], // light 日间模式 ， dark夜间模式， auto根据时间和主题自动夜间模式
  APPEARANCE_DARK_TIME: process.env.NEXT_PUBLIC_APPEARANCE_DARK_TIME || [18, 6], // 夜间模式起至时间，false时关闭根据时间自动切换夜间模式

  // 3.14.1版本后，欢迎语在此配置，英文逗号隔开 ,  即可支持多个欢迎语打字效果。
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '就是这样的烂诗人',
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '就是这样的烂诗人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://wpot.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '博客,就是这样的烂诗人,泪眼之前，Notion', // 网站关键词 英文逗号隔开
  ...
  COMMENT_CUSDIS_APP_ID: process.env.NEXT_PUBLIC_COMMENT_CUSDIS_APP_ID || 'a2c7d291-cd94-4016-a4ec-012fa6f54968', // data-app-id 36位 see https://cusdis.com/
  COMMENT_CUSDIS_HOST:
  ...
  ANALYTICS_51LA_ID: process.env.NEXT_PUBLIC_ANALYTICS_51LA_ID || '3FdSWngO7bOazAX9', // id，在51la后台获取 参阅 https://docs.tangly1024.com/article/notion-next-51-la
  ANALYTICS_51LA_CK: process.env.NEXT_PUBLIC_ANALYTICS_51LA_CK || '3FdSWngO7bOazAX9', // ck，在51la后台获取
